...
export default function LandingPage() {
    return (
        <div className="font-sans text-gray-900 bg-white">
            {/* Header */}
            <header className="flex justify-between items-center px-6 py-4 shadow-md bg-yellow-400">
                <h1 className="text-2xl font-bold">HappyTravels</h1>
                <a
                    href="tel:+918077424137"
                    className="flex items-center gap-2 bg-white text-gray-900 px-4 py-2 rounded-xl font-semibold"
                >
